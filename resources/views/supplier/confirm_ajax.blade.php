    ...
    <script>
        $(document).ready(function () {
                        ...
                        success: function (response) {
                            if (response.status) {
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href = "{{ url('supplier') }}"; // ⬅ Langsung redirect ke halaman supplier
                                });
                            } else {
                                $('.error-text').text('');
            ...
            function deleteSupplier(supplier) {
                console.log("Fungsi deleteSupplier dipanggil", supplier);

                $("#form-delete").attr("action", "{{ url('/supplier') }}/" + supplier.supplier_id + "/delete_ajax");
